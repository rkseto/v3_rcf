...
void amptana3(int itype=1,int ntodo=-1, int irot=0, int i_inject=0, double Ecm=7.7, double bmin=0., double bmax=14.) {
  ...
  for(int iev=0; iev<nev; iev++){
   ...
   //    double bmin=0;
	...
	if(rapidity[i] > rapiditymincut_2 && rapidity[i] < rapiditymaxcut_2)cth_1_b_all_h->Fill(b_impact,cth1*eta[i]/abs(eta[i]));
	...
	if(part_id[i]==211 && rapidity[i] > rapiditymincut_2 && rapidity[i] < rapiditymaxcut_2) cth_1_b_pip_h->Fill(b_impact,cth1*eta[i]/abs(eta[i]));
	...
	if(part_id[i]==-211 && rapidity[i] > rapiditymincut_2 && rapidity[i] < rapiditymaxcut_2) cth_1_b_pim_h->Fill(b_impact,cth1*eta[i]/abs(eta[i]));
	...
	if(part_id[i]==321 && rapidity[i] > rapiditymincut_2 && rapidity[i] < rapiditymaxcut_2) cth_1_b_kp_h->Fill(b_impact,cth1*eta[i]/abs(eta[i]));
	...
	if(part_id[i]==-321 && rapidity[i] > rapiditymincut_2 && rapidity[i] < rapiditymaxcut_2) cth_1_b_km_h->Fill(b_impact,cth1*eta[i]/abs(eta[i]));
	...
	if(part_id[i]==2212) cth_1_b_pr_h->Fill(b_impact,cth1*eta[i]/abs(eta[i]));
	...
	if(rapidity[i] > rapiditymincut_2 && rapidity[i] < rapiditymaxcut_2)cth_3_b_all_h->Fill(b_impact,cth3*eta[i]/abs(eta[i]));
	...
	if(part_id[i]==211 && rapidity[i] > rapiditymincut_2 && rapidity[i] < rapiditymaxcut_2) cth_3_b_pip_h->Fill(b_impact,cth3*eta[i]/abs(eta[i]));
	...
	if(part_id[i]==-211 && rapidity[i] > rapiditymincut_2 && rapidity[i] < rapiditymaxcut_2) cth_3_b_pim_h->Fill(b_impact,cth3*eta[i]/abs(eta[i]));
	...
	if(part_id[i]==321 && rapidity[i] > rapiditymincut_2 && rapidity[i] < rapiditymaxcut_2) cth_3_b_kp_h->Fill(b_impact,cth3*eta[i]/abs(eta[i]));
	...
	if(part_id[i]==-321 && rapidity[i] > rapiditymincut_2 && rapidity[i] < rapiditymaxcut_2) cth_3_b_km_h->Fill(b_impact,cth3*eta[i]/abs(eta[i]));
	...
	if(part_id[i]==2212 && rapidity[i] > rapiditymincut_2 && rapidity[i] < rapiditymaxcut_2) cth_3_b_pr_h->Fill(b_impact,cth3*eta[i]/abs(eta[i]));
