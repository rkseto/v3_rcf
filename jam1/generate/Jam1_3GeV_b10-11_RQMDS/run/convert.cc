...
int main(void) {
    ...
    jam.mevent=500;    //Event amount
    //jam.mevent=1000; //Event amount
    jam.bmin=10;       //Minimum impact parameter b
    jam.bmax=-10.4;     //Maximum impact parameter b
    ...
    //jam.dt=40;
    //jam.nstep=1;
    jam.dt=1;       //Time step in fm/c
    jam.nstep=50;
    jam.mstc(6)=101;  //Mean Field, RQMD/S
